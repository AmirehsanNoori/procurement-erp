...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    module: 'warehouse',
    items: [
      { key: 'invRequests', path: '/inventory/requests', label: 'ثبت درخواست خرید', icon: '📝', permission: 'warehouse.view' },
      { key: 'invStock', path: '/inventory/stock', label: 'موجودی انبار', icon: '📦', permission: 'warehouse.view' },
      { key: 'invValuation', path: '/inventory/valuation', label: 'ارزش موجودی', icon: '💰', permission: 'warehouse.view' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'finCcReport', path: '/finance/cost-center-report', label: 'گزارش مراکز هزینه', icon: '🧭', permission: 'finance.view' },
      ...
      { key: 'finCostCenters', path: '/finance/cost-centers', label: 'مراکز هزینه', icon: '🏷️', permission: 'finance.view' },
